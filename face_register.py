...
class Register:
    def __init__(self):
        ...
        # SSD
        self.caffe_model = "face_detection_model/deploy.prototxt"
        self.caffe_weights = "face_detection_model/res10_300x300_ssd_iter_140000.caffemodel"
        self.net = cv2.dnn.readNetFromCaffe(self.caffe_model, self.caffe_weights)
        self.conf = 0.5

    def register(self):
        name = input("Input your name:")
        reg_path = os.path.join("dataset", name)
        print(reg_path)
